  ...
  return (
    <>
      ...
      <form
        id={formId || undefined}
        ref={formRef}
        className={`sales-new-sale animate-in${modalMode ? ' sales-new-sale--modal' : ''}`}
        onSubmit={submit}
      >
          ...
          >
            <div className="sales-checkout card">
              ...
              <label className="sales-deferred-toggle">
                ...
                />
                <span>Vender a prazo (sem pagamento agora)</span>
              </label>
