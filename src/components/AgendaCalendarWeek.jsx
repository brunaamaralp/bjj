...
export default function AgendaCalendarWeek({
    ...
    return (
        ...
        .aula-card:hover {
          border-color: #6C47D8;
          box-shadow: 0 2px 8px rgba(108, 71, 216, 0.10);
        ...
        .dot-green,
        .aula-dot.dot-green { background: #1FAA5E; }
        .aula-dot--pending { background: #C47A00; }
        .aula-dot--attended { background: #1FAA5E; }
        .aula-dot--missed { background: #E24B4A; }
        .aula-time {
          font-size: 11px;
          font-weight: 600;
          color: #6C47D8;
