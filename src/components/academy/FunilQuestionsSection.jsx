      ...
      <div className="funil-question-row-main">
        ...
        {canEdit && (
          <div className="funil-question-actions">
            ...
            <button type="button" className="icon-btn icon-only" title="Remover" onClick={onRemove}>
              <X size={14} />
            </button>
          </div>
        )}
...
export default function FunilQuestionsSection({ academy, setAcademy, academyId, academyDataVersion = 0 }) {
  ...
  return (
    <div className="finance-settings-section-body">
      <p className="text-small text-muted" style={{ margin: '0 0 12px', lineHeight: 1.45 }}>
        Perguntas extras no perfil do {contactLabel.toLowerCase()} e na matrícula.
      </p>
      <div className="card">
        <div className="flex-col gap-3" style={{ padding: 16 }}>
          {canEdit && (
