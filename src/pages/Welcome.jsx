  ...
  <div className="navi-lp">
        ...
        <div className="navi-lp-inner navi-lp-inner--prose">
          ...
          <ul className="navi-lp-checklist">
            {POSICIONAMENTO_ITENS.map((text) => (
              <li key={text}>
                <Check size={16} strokeWidth={2.5} color="var(--petroleo)" aria-hidden="true" />
                {text}
              </li>
            ))}
          </ul>
    ...
    <style dangerouslySetInnerHTML={{
      ...
      @media (max-width: 520px) {
        ...
        .navi-lp-nav { min-height: 84px; padding: 12px var(--nl-pad); }
        .navi-lp-nav-brand .navi-brand-lockup,
        .navi-lp-nav-brand .navi-brand-lockup--lp-nav {
      ...
      .wapp-online-dot {
        ...
        box-shadow: 0 0 6px var(--lp-neon), 0 0 12px rgba(37, 211, 102, 0.4);
