import { PAYMENT_METHODS, paymentMethodLabel, canonicalPaymentMethodKey } from './paymentMethods.js';
...
export function formatPaymentMethod(method, installments) {
  ...
  const base = paymentMethodLabel(canonical) || PAYMENT_METHOD_LABELS[canonical] || raw;
