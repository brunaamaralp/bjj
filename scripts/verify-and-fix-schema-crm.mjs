...
const LEADS_ATTRS = [
  ...
  { key: 'pipeline_stage_changed_at', type: 'datetime' },
  ...
  { key: 'last_whatsapp_activity_at', type: 'datetime' },
  { key: 'last_note_at', type: 'datetime' },
  ...
  { key: 'whatsapp_classified_at', type: 'datetime' },
  { key: 'need_human', type: 'boolean' },
  { key: 'attended_at', type: 'datetime' },
  { key: 'missed_at', type: 'datetime' },
  { key: 'lost_at', type: 'datetime' },
...
const BANK_STATEMENT_ITEMS_ATTRS = [
  ...
  { key: 'match_tier', type: 'string', size: 32 },
  { key: 'suggested_candidates_json', type: 'string', size: 2048 },
  { key: 'status', type: 'string', size: 16 },
