...
/**
 * Cadastro de assinante PagBank (cartão). student_payments com method pagbank nasce no webhook
 * (paid/pending) — ver comentário em pagbankSubscriptionHandler.js sobre registro no 1º mês.
 */
