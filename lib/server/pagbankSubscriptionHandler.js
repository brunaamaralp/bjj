 ...
 *
 * Decisão pendente (não implementar agora): criar student_payments pending no primeiro mês
 * ao ativar a assinatura. Depende de alinhar due_date com due_day do aluno — hoje o registro
 * em student_payments só nasce no webhook de pagamento (paid) ou na falha definitiva (pending).
 */
