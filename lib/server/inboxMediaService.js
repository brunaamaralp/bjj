...
const BUCKET_ID = () =>
  String(process.env.APPWRITE_MEDIA_BUCKET_ID || process.env.APPWRITE_INBOX_MEDIA_BUCKET_ID || '').trim();
...
/**
 * Baixa mídia efêmera e persiste no Appwrite Storage; retorna URL permanente de visualização.
 * @returns {Promise<string | null>}
 */
export async function downloadAndSaveMedia(mediaUrl, mimeType, opts = {}) {
  ...
  return stored?.permanentUrl ?? null;
}
