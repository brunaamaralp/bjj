...
export default async function handler(req, res) {
  ...
  // QR code served as <img src> — browser never sends Authorization header.
  // Auth not needed here: the instance ID + server-side ZAPSTER_TOKEN is sufficient,
  // and QR codes rotate every ~30s so exposure risk is negligible.
