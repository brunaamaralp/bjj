...
import { mapFinanceTxDoc, buildFinanceTxPayload, txDirection } from './financeTxFields.js';
...
async function handleCreateTxFromItem(req, res, academyId, me) {
  ...
  const tx = await databases.createDocument(DB_ID, FINANCIAL_TX_COL, ID.unique(), payload, defaultPerms());
