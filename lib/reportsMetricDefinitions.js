...
export const REPORT_METRIC_DEFINITIONS = {
  ...
  experimentalByProfessor: {
    id: 'experimentalByProfessor',
    label: 'Experimentais por professor',
    formula:
      'Compareceu (attended_at) e matrículas (ingresso/converted_at) no período, agrupados por experimental_professor_user_id',
    source: 'Coleção leads (+ students) · experimental_professor_*',
    tooltip:
      'Comissão = comparecimentos com professor. Conversão = matrículas atribuídas ao professor da experimental. Sem responsável = campo vazio.',
  },
  missed: {
    id: 'missed',
