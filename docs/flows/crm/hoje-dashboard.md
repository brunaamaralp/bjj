...
**Arquivos-chave:** `src/pages/Dashboard.jsx`, `src/components/recepcao/RecepcaoCatracaTab.jsx`, `src/components/recepcao/RecepcaoSchedulesGrid.jsx`, `src/components/dashboard/*`, `src/lib/recepcaoHubTabs.js`
