...
- **Nota no histórico:** no perfil (campo de nota + opt-in **Notificar equipe**) ou via FAB global **Nota rápida** (desktop); notificação no sino (`profile_note`) quando marcado
